...
global.github = 'https://github.com/kushansewmina1234/JUNAID-King-MD'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'JUNAID-King-MD' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'DARKJUNAID' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'DARKJUNAID' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'true' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'DARK-JUNAID-MD' : process.env.PACK_NAME.split(";")[1],
  ...
  LANG: process.env.THEME|| 'DARKJUNAID',
