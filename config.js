...
global.github = 'https://github.com/kushansewmina1234/JUNAID'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'JUNAID' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'JUNAID' : process.env.OWNER_NAME,
